...
set SRCDIR_XPOSED=%SRCDIR_APPTWEAK%\xposed
...
mkdir %~dp0\tmp
%JDK_BIN_DIR%javac -encoding UTF-8 -classpath %ANDROID_API%\android.jar;%ANDROID_API%\optional\*;%~dp0\libs\* -d %~dp0\tmp %SRCDIR_APPTWEAK%\*.java %SRCDIR_PLUGIN%\*.java %SRCDIR_UTIL%\*.java %SRCDIR_XPOSED%\*.java
